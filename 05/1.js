...
while (
  ...
  if (commands[i] === 99) {
    ...
    commands[!+com[0] ? commands[i + 1] : i + 1] = 5;
    i += 2;
  } else if (
    commands[i]
      .toString()
    ...
    const com = commands[i].toString().padStart(3, "0");
    console.log(commands[!+com[0] ? commands[i + 1] : i + 1]);
    i += 2;
  } else if (
    commands[i]
      .toString()
